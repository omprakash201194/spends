...
class CategoryControllerTest {
    ...
    void create_withValidParent_setsParentOnSavedCategory() {
        ...
        var req = new CategoryController.CreateRequest("Swiggy", "#00f", null, null, parent.getId());
    ...
    void update_withNullParentId_doesNotClearParent() {
        ...
        var req = new CategoryController.UpdateRequest("Swiggy Renamed", null, null, null, null, false);
    ...
    void update_withClearParent_removesParent() {
        ...
        var req = new CategoryController.UpdateRequest(null, null, null, null, null, true);
        var response = controller.update(principal, catId, req);
    ...
    void update_circularReference_throwsBadRequest() {
        ...
        var req = new CategoryController.UpdateRequest(null, null, null, null, childId, false);
        var ex = assertThrows(org.springframework.web.server.ResponseStatusException.class,
