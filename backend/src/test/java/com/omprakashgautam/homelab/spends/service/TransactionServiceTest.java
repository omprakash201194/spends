...
class TransactionServiceTest {
    ...
    void getTimeAggregates_returnsYearsOnly_whenYearNotSet() {
        ...
        when(aggregateQuery.yearAggregates(any())).thenReturn(List.of(
                new TransactionDto.YearAgg(2026, 424, 37, java.math.BigDecimal.ZERO, java.math.BigDecimal.ZERO),
                new TransactionDto.YearAgg(2025, 1200, 50, java.math.BigDecimal.ZERO, java.math.BigDecimal.ZERO)
        ));
    ...
    void getTimeAggregates_returnsMonthsArray_whenYearSet_zeroFillsAllTwelve() {
        ...
        when(aggregateQuery.monthAggregates(any(), eq(2026))).thenReturn(List.of(
                new TransactionDto.MonthAgg(5, 142, 18, java.math.BigDecimal.ZERO, java.math.BigDecimal.ZERO),
                new TransactionDto.MonthAgg(6, 80, 4, java.math.BigDecimal.ZERO, java.math.BigDecimal.ZERO)
        ));
    ...
    void getTimeAggregates_returnsWeekBuckets_whenYearAndMonthSet_zeroFillsBuckets() {
        ...
        when(aggregateQuery.weekAggregates(any(), eq(2026), eq(5))).thenReturn(List.of(
                new TransactionDto.WeekAgg(0, 1, 7, 34, 5, java.math.BigDecimal.ZERO, java.math.BigDecimal.ZERO),
                new TransactionDto.WeekAgg(2, 15, 21, 28, 7, java.math.BigDecimal.ZERO, java.math.BigDecimal.ZERO)
        ));
    ...
    void getTimeAggregates_zeroFillsCorrectBucketCount_forFebruaryNonLeap() {
        UUID userId = UUID.randomUUID();
        when(aggregateQuery.yearAggregates(any())).thenReturn(List.of(
                new TransactionDto.YearAgg(2026, 100, 5, java.math.BigDecimal.ZERO, java.math.BigDecimal.ZERO)));
        when(aggregateQuery.monthAggregates(any(), eq(2026))).thenReturn(List.of(
                new TransactionDto.MonthAgg(2, 50, 3, java.math.BigDecimal.ZERO, java.math.BigDecimal.ZERO)));
